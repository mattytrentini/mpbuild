...
![Interactive TUI screenshot](docs/interactive.svg)
...
> [!NOTE]
> The screenshot is regenerated by `uv run python docs/screenshot.py` against a synthesised fake MicroPython tree — re-run after any visual change to the TUI.
